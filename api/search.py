...
from .constants import BATCH_SIZE, DEFAULT_WANTED_FIELDS, MAX_PAID_FIELDS_PER_ORDER, PLATFORM_FEE_BPS
...
def build_quote_detail(quote):
    ...
    matches = quote.get("matches") or build_matches(profile_ids, filters, wanted_fields)
    ...
    return {
        ...
        "matches": matches,
        "matchedProfileCount": quote.get("matchedProfileCount", len(profile_ids)),
        "paidFieldCount": quote.get("paidFieldCount", 0),
        "freeFieldCount": quote.get("freeFieldCount", 0),
        "subtotalCents": quote.get("subtotalCents", 0),
        "serviceFeeCents": quote.get("serviceFeeCents", 0),
        "totalCents": quote.get("totalCents", 0),
        "currency": quote.get("currency", "IP"),
